...
class ToolRegistryMixin:
    ...
    def get_available_tools(self) -> list:
        ...
        return [
            ...
            {"name": "send_terminal_input", "description": "Send input (stdin) to a running background process. Args: process_id (str), input_text (str)"},
            {"name": "stop_background_process", "description": "Kill/terminate a running background process. Args: process_id (str)"},
    ...
    async def execute(self, tool_name: str, **kwargs) -> str:
        ...
        tool_map = {
            ...
            "send_terminal_input": self.send_terminal_input,
            "stop_background_process": self.stop_background_process,
